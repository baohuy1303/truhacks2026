    ...
    <>
      ...
      >
        ...
        <div className="hidden md:flex gap-8 lg:gap-12 items-center">
          ...
          <NavLink text="Tracks" onClick={() => scrollToSection('tracks')} />
          <NavLink text="Prizes" onClick={() => scrollToSection('prizes')} />
          <NavLink text="Sponsors" onClick={() => scrollToSection('sponsors')} />
          <NavLink text="Team" onClick={() => scrollToSection('team')} />
        </div>

        <div className="flex items-center gap-4">
          <button 
            onClick={() => window.open('YOUR_REGISTRATION_LINK', '_blank')}
            className="hidden sm:block bg-white/10 hover:bg-white/20 text-white border border-white/20 px-4 sm:px-6 py-2 rounded-full font-bold text-xs sm:text-sm transition-all backdrop-blur-md whitespace-nowrap"
          >
            REGISTER NOW
          </button>
      ...
      {isOpen && (
        ...
        >
          <div className="flex flex-col py-4 px-6 space-y-4">
            ...
            <MobileNavLink text="Tracks" onClick={() => scrollToSection('tracks')} />
            <MobileNavLink text="Prizes" onClick={() => scrollToSection('prizes')} />
            <MobileNavLink text="Sponsors" onClick={() => scrollToSection('sponsors')} />
            <MobileNavLink text="Team" onClick={() => scrollToSection('team')} />
            <button 
              onClick={() => window.open('YOUR_REGISTRATION_LINK', '_blank')}
...
const NavLink = ({ text, onClick }) => (
  <button 
    onClick={onClick}
    className="text-white/70 hover:text-white font-sans text-base lg:text-lg tracking-wide transition-colors relative group"
  >
    {text}
